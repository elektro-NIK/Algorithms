...
for i in range(4,n+1):
  print '| %-20.3f | %-20.3f |' % (x,y)
  y_n1 = res_y[len(res_y)-1]+1./24*h*(55*res_f[len(res_f)-1]-59*res_f[len(res_f)-1-1]+37*res_f[len(res_f)-1-2]-9*res_f[len(res_f)-1-3])
  y_k = res_y[len(res_y)-1]+1./24*h*(9*f(x+h, y_n1)-19*res_f[len(res_f)-1]-37*res_f[len(res_f)-1-1]-res_f[len(res_f)-1-2])
